...
def conectar():
    try:
        db_connection = mysql.connector.connect(host='localhost', user='root', password='', database='dbti13n')
        print('conectado com sucesso!')
        return db_connection
    except mysql.connector as erro: #Guardando as possíveis exceções na varável erro
